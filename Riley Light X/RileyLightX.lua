...
sidebar.Visible = false -- Initially hidden
...
executorGui.Position = UDim2.new(0, 60, 0, 0)
executorGui.Size = UDim2.new(1, -60, 1, 0)
...
homeGui.Position = UDim2.new(0, 60, 0, 0)
homeGui.Size = UDim2.new(1, -60, 1, 0)
