...
local Window = OrionLib:MakeWindow({Name = "Riley Hub X", HidePremium = false, SaveConfig = true, ConfigFolder = "RileyHubX"})
...
OrionLib:MakeNotification({
	Name = "Auto Parry (Rage)",
	Content = "Enable Auto Parry from Combat for Auto Rage Parry to work.",
