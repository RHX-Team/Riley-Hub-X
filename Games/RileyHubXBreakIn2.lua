...
local Window = OrionLib:MakeWindow({Name = "Riley Hub X", HidePremium = false, SaveConfig = true, IntroEnabled = true, IntroText="Riley Hub X"})
-- Var
...
homeS:AddLabel("Hey there, "..plr.Name.."! Thank you for Using Riley Hub X")

local homeU = home:AddSection({Name = "Updates"})
homeU:AddLabel(game:HttpGet("https://raw.githubusercontent.com/RileyBeeRBLX/RileyHub/main/UpdateNew/Breakin2.update"))
-- Tabs
...
inf:AddButton({
    Name = "Get Infinite Yield (Mobile)",
    Callback = function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/RileyBeeOrion/Scripts/main/InfiniteYieldDeltaMobile.lua"))()
    end
})
