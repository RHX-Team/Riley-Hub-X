...
--Mastery
    Tabs.Main:AddParagraph({
        Title = "Mastery Farm",
        Content = "Auto Farm And Upgrade Your Mastery"
    })
...
CamShake:Stop()
    ...
    local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "Bypass Teleport", Default = false })
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Remove Name Text", Default = true })
...
local ToggleRandomFruit = Tabs.Fruit:AddToggle("ToggleRandomFruit", {Title = "Roll Random Fruit", Default = false })
...
local ToggleRandomBone = Tabs.Shop:AddToggle("ToggleRandomBone", {Title = "Roll Random Bone", Default = false })
